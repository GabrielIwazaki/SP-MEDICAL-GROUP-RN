...
import { Text, Image, StyleSheet, View, TouchableOpacity, AsyncStorage, FlatList } from "react-native";
import Axios from 'axios';
import api from '../services/api';


class mainComum extends Component {
    ...
    renderizaItem = ({ item }) => (
        <View style={styles.li}> 
            <Text style={styles.itemname}>{item.idMedicoNavigation.nome}</Text>
